    ...
    <div className={styles.aboutSection}>
      <div className={styles.contentBox}>
        ...
        <p className={styles.aboutText}>
          ...
          while also keeping myself busy and learning by creating projects that
        ...
        <p className={styles.aboutText}>
          ...
          I&apos;m an animal lover that has two cats named Bean and Sam as well
          as two dogs. (I prefer cats though). Other than that I love to go to
          the gym and go for walks and I am a big fan of grand strategy video
